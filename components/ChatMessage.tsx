...
const ChatMessageComponent: React.FC<ChatMessageProps> = ({ message, onExpandQuery, isLastMessage }) => {
            ...
            <div className="mt-4">
                {hasSummary && (
                    <button
                        ...
                        className="flex items-center gap-2 text-sm text-teal-600 hover:text-teal-800 font-semibold transition-colors mb-3"
                    >
                ...
                {(!hasSummary || isAnswerExpanded) && (
                  <div className="w-full pt-3 border-t border-gray-200 space-y-4">
